...
const CACHE_PREFIX    = 'bunko_html_v24_'; // HTML形式キャッシュ（v24: index.cssのruby rt競合ルール削除、letter-spacing除去でルビ位置修正）
